...
public class AristoWebLogMsgConstant {
	...
	public static final String Abm_Reporting_CONTROLLER="AbmReportingController {} method execution started , login_id: {}";
	public static final String Abm_Reporting_SERVICE="AbmReportingServiceImpl:: {} method execution started, , login_id: {} ";
