...
public interface UserRightsReportDao extends JpaRepository<UserReports, Integer>{
	...
	@Query(value = "select r.tab_id,t.tab_name,r.repo_id,r.repo_name,ifnull(u.status,'N') user_status,ifnull(u.id,0) id from repo_master r "+
	" join tab_master t on  r.tab_id=t.tabid and r.lock='Y' "+
