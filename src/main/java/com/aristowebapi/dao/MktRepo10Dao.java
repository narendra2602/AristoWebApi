...
public interface MktRepo10Dao extends JpaRepository<MktDataDto, Integer>{
	
	@Query(value="CALL web_report_br_hq_trend(:myear,:div_code,:depo_code,:smon,:emon,:utype,:login_id);", nativeQuery=true)
	List<MktRepo10> getWebReportBrHqTrend(@Param("myear") int myear,@Param("div_code") int div_code,@Param("depo_code") int depo_code,
