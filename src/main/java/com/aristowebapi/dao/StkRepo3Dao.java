...
public interface StkRepo3Dao extends JpaRepository<MktDataDto, Integer> {
	...
	@Query(value="CALL aristo_web.StockiestRepo3(:myear,:div_code,:depo_code,:smon,:emon,:rep_type);", nativeQuery=true)
	List<StkRepo3> getStockiestRepo2(@Param("myear") int myear,@Param("div_code") int div_code,@Param("depo_code") int depo_code,
